...
namespace CafeBoston.UI
{
    public partial class MainForm : Form
    {
        ...
        {
            if (db.Products.Count>0) return;/*if(db.Products.Any())*/
        ...
        private void lvwTables_DoubleClick(object sender, EventArgs e)
        {
           ...
           var frmOrder=new OrderForm(db,order);
            //frmOrder.Text=tableNo.ToString();
        ...
        private void FrmOrder_TableMoving(int oldTableNo, int newTableN0)
        {
